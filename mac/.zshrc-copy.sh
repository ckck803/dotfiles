...
POWERLEVEL10K_COLOR_SCHEME='white'
...
#powerlevel10k 아이콘 관련

# os icon
POWERLEVEL10K_OS_ICON_BACKGROUND="black"
POWERLEVEL10K_OS_ICON_FOREGROUND="196"

# dir icon
POWERLEVEL10K_DIR_HOME_FOREGROUND="195"
POWERLEVEL10K_DIR_HOME_SUBFOLDER_FOREGROUND="195"
POWERLEVEL10K_DIR_DEFAULT_FOREGROUND="195"
...
# POWERLEVEL10K_BATTERY_CHARGING_ICON='\uf1e6'
# POWERLEVEL10K_BATTERY_CHARGED_ICON='\uf1e6'
# POWERLEVEL10K_MULTILINE_LAST_PROMPT_PREFIX='\uf0da'

# 오른쪽 시간과 관련된 부분
POWERLEVEL10K_TIME_BACKGROUND='white'
# POWERLEVEL10K_CUSTOM_TIME_FORMAT="%D{\uf017 %H:%M:%S}"
...
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status nvm time battery dir_writable)
